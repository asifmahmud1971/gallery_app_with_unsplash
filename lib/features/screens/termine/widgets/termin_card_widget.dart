...
import 'package:terminator/features/screens/termine/widgets/button_widget.dart';
import 'package:terminator/features/screens/termine/widgets/row_widget.dart';

class TerminCardWidget extends StatelessWidget {
  final VoidCallback? onView;
  final VoidCallback? onEdit;
  final GalleryModel? galleryModel;
  final bool isToday;
  const TerminCardWidget(
      {super.key,
      this.onView,
      this.galleryModel,
      this.onEdit,
